...
public class ShowMultiplesOf2NumbersTest {
    @Test
    public void testSomeValues14() {
        List<Integer> list1 = ShowMultiplesOf2Numbers.findMultiples(2,4,40);
    ...
    public void testSomeValues() {
        List<Integer> list1 = ShowMultiplesOf2Numbers.findMultiples(5,13,800);
    ...
    public void testSomeValues4() {
        List<Integer> list1 = ShowMultiplesOf2Numbers.findMultiples(7,16,1000);
